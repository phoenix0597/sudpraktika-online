...
**Зафиксировать текущий SSG/UX checkpoint коммитом**, затем перейти к настройке локального веб-сервера для просмотра прототипа через `http://localhost/...` с нормальными абсолютными маршрутами.
...
1. **Закоммитить текущий SSG/UX checkpoint** — генератор, `site_prototype/`, обновлённый словарь enum и memory-файлы.
