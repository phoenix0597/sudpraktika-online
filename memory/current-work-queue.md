...
2. **Передать выбранному ИИ-агенту задачу на следующую партию парсинга/структурирования** — `data/review/_TASK_PARSE_NEXT_BATCH_AGY.md`; стартовая точка `data/parse_batches/.../batch_state.md`. *(Повторяющаяся задача)*
