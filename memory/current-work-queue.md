...
- Кодовая база: скрипты сбора/извлечения/верификации работают; данных — 1 акт (data/raw_acts/), пилотный сайт ещё не начат.
...
4. **Тест интеграции Antigravity:** Успешно выполнен 2026-06-25. Обработан пилотный акт `yQ8qgPoesvWJ`, сгенерированы `user_story_yQ8qgPoesvWJ.md` и `practice_yQ8qgPoesvWJ.md` без галлюцинаций, проверены верификатором.
