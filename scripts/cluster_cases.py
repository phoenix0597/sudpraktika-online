...
CLUSTERS: dict[str, Cluster] = {
    ...
    "proper_quality_goods_exchange_art25": Cluster(
        "proper_quality_goods_exchange_art25",
        "Обмен или возврат товара надлежащего качества",
        "Когда можно вернуть или обменять качественный товар, который не подошёл",
        "long_tail",
    ),
    "unfair_terms_imposed_services_art16": Cluster(
        "unfair_terms_imposed_services_art16",
        "Недопустимые условия договора и навязанные услуги",
        "Как суды оценивают навязанные услуги и ущемляющие условия договора",
        "landing",
    ),
    "harm_from_defect_art14": Cluster(
        "harm_from_defect_art14",
        "Вред от недостатка товара, работы или услуги",
        "Возмещение вреда имуществу, жизни или здоровью из-за недостатка",
        "landing",
    ),
    "consumer_material_damage_art35": Cluster(
        "consumer_material_damage_art35",
        "Утрата или повреждение вещи потребителя при выполнении работ",
        "Что взыскивают при повреждении вещи, переданной исполнителю",
        "pillar",
    ),
