...
Кандидаты на новые ситуации ЗоЗПП см. в `memory/topic-content-fill-plan.md` в разделе «Кандидаты на новые ситуации ЗоЗПП». Учитывай их при поиске очередной партии как разведочные направления.

Если найдено дело, похожее на кандидатную новую ситуацию, но соответствующего кода ещё нет в `data/reference/zpp_enum_dictionary.json`:
